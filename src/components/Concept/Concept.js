       ...
       <div className="containerConcept">
           <div className="row">
              <div className="concept_left">
                <div className="bg">
                  <img src="/images/accueil.jpg" alt="" className='concept_img'  />
              ...
              <div className="concept_right">
                <ul className="concept_list">
                    <li>
                      <i className="icon_billeterie"></i>
                      <div className="item">
                        <h4>Inscription à l'événement / Billetterie</h4>
                        <p>Gérez simplement les inscriptions de tous vos participants et utilisez l'application mobile ZN Event pour contrôler les accès à l'entrée de l'événement</p>
                      </div>
                    </li>
                    <li>
                       <i className="icon_paiements"></i>
                       <div className="item">
                    ...
                    <li>
                       <i className="icon_participants"></i>
                       <div className="item">
                    ...
                    <li>
                      <i className="icon_prestataires"></i>
                      <div className="item">
